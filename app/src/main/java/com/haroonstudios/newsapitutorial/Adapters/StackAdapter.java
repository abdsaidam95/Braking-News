...
public class StackAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewDesciption = (TextView)convertView.findViewById(R.id.newsDescription);
        ...
        textViewDesciption.setText(arrayListArticles.get(position).getDescription());
